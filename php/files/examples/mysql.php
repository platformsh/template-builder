...
print "<summary>MySQL Sample Code</summary>\n";

print "<section style='border:1px solid'>\n";
...
try {
    ...
    $dsn = sprintf('mysql:host=%s;port=%d;dbname=%s', $database['host'], $database['port'], $database['path']);
