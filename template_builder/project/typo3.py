...
class Typo3(RemoteProject):
    ...
    def platformify(self):
        ...
        return super(Typo3, self).platformify + [
            ...
            'cd {0} && composer update --no-scripts'.format(self.builddir) + ' '.join(self.composer_defaults()),
            'cd {0} && composer require typo3/cms-introduction platformsh/config-reader pixelant/pxa-lpeh'.format(self.builddir) + ' '.join(self.composer_defaults()),
