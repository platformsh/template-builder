...
* The `.platform.template.yaml` file contains information needed by Platform.sh's project setup process.  It may be safely ignored or removed.
* An additional Composer library, `platformsh/configreader`, has been added.  It provides convenience wrappers for accessing the Platform.sh environment variables.
