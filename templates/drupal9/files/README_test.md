...
| Action         | File | Purpose    |
|:--------------|:-----------|:--------|
| ![update](https://img.shields.io/badge/mod-%20?style=for-the-badge&labelColor=f4f2f3&color=23b7b7) | [`config/sync/.gitkeep`](config/sync/.gitkeep) | Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec molestie mauris ut magna laoreet tempor. |
| ![update](https://img.shields.io/badge/mod-%20?style=for-the-badge&labelColor=f4f2f3&color=23b7b7) | [`web/sites/default/settings.php`](web/sites/default/settings.php) | Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec molestie mauris ut magna laoreet tempor. |
| ![update](https://img.shields.io/badge/mod-%20?style=for-the-badge&labelColor=f4f2f3&color=23b7b7) | [`web/sites/default/settings.platformsh.php`](web/sites/default/settings.platformsh.php) | Contains Platform.sh-specific configuration, namely setting up the database connection to the MariaDB service and caching via Redis. |
| ![update](https://img.shields.io/badge/mod-%20?style=for-the-badge&labelColor=f4f2f3&color=23b7b7) | [`.environment`](.environment) | Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec molestie mauris ut magna laoreet tempor. |
| ![update](https://img.shields.io/badge/mod-%20?style=for-the-badge&labelColor=f4f2f3&color=23b7b7) | [`.gitignore`](.gitignore) | Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec molestie mauris ut magna laoreet tempor. |
| ![update](https://img.shields.io/badge/mod-%20?style=for-the-badge&labelColor=f4f2f3&color=23b7b7) | [`.lando.upstream.yml`](.lando.upstream.yml) | Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec molestie mauris ut magna laoreet tempor. |
| ![update](https://img.shields.io/badge/mod-%20?style=for-the-badge&labelColor=f4f2f3&color=23b7b7) | [`.platform.app.yaml`](.platform.app.yaml) | This file is required to define the build and deploy process for all application containers on Platform.sh. Within this file, the runtime version, relationships to service containers, and writable mounts are configured. Take a look at the [Application](https://docs.platform.sh/configuration/app.html) documentation for more details about configuration. Here's a second custom line about the app itself after the shared generic file. |
| ![update](https://img.shields.io/badge/mod-%20?style=for-the-badge&labelColor=f4f2f3&color=23b7b7) | [`drush/platformsh_generate_drush_yml.php`](drush/platformsh_generate_drush_yml.php) | Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec molestie mauris ut magna laoreet tempor. |
| ![update](https://img.shields.io/badge/add-%20?style=for-the-badge&labelColor=f4f2f3&color=ffd9d9) | [`.platform/services.yaml`](.platform/services.yaml) |    |
| ![update](https://img.shields.io/badge/add-%20?style=for-the-badge&labelColor=f4f2f3&color=ffd9d9) | [`.platform/routes.yaml`](.platform/routes.yaml) |    |
