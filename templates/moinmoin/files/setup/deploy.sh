...
if [ ! -f wiki/underlay/moin.installed ]; then
    ...
    cp -a ~/setup/temp/pages/* /mnt/pages
    cp -a ~/setup/temp/cache/* /mnt/cache
    cp -a ~/setup/temp/underlay/* /mnt/underlay
    cp -a ~/setup/temp/edit-log /mnt/logging
    cp -a ~/setup/temp/event-log /mnt/logging
