OC.L10N.register(
    ...
    "A Nextcloud Enterprise Subscription means the original developers behind your self-hosted cloud server are 100% dedicated to your success: the security, scalability, performance and functionality of your service!" : "Ein Nextcloud-Unternehmens-Abonnement bedeutet, dass sich die Entwickler hinter Ihrem  privaten Cloud-Server zu 100 % Ihrem Erfolg widmen: der Sicherheit, Skalierbarkeit, Leistung und Funktionalität Ihres Dienstes!",
    ...
    "You have access to the right documentation and expertise to quickly answer compliance questions or deliver on GDPR, HIPAA and other regulation requirements." : "Sie haben Zugriff auf die richtige Dokumentation und das richtige Fachwissen, um Fragen zur Compliance, GDPR, HIPAA und andere Vorschriften schnell beantworten zu können.",
    ...
    "This mail was sent to all administrators by the support app on your Nextcloud instance at %s because you have more users than your subscription covers." : "Diese E-Mail wurde von der Support-App Ihrer Nextcloud-Instanz unter %s an alle Administratoren verschickt, weil mehr Benutzer registriert sind als das Nextcloud-Abonnement abdeckt.",
    "Your Nextcloud server Subscription is expired" : "Ihr Nextcloud-Server-Abonnement ist abgelaufen",
    "Your Nextcloud server Subscription is expired!" : "Ihr Nextcloud-Server-Abonnement ist abgelaufen!",
    "Your Nextcloud Subscription has expired! Please contact your Nextcloud account manager to get your subscription updated!" : "Ihr Nextcloud Abonnement ist abgelaufen! Bitte kontaktieren Sie Ihren Accountmanager um das Abonnement verlängert zu bekommen.",
