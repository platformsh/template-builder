OC.L10N.register(
    ...
    "You have a contract with the vendor providing early security information, mitigations, patches and updates." : "Vostede ten un contrato co provedor que fornecerá información precoz da seguridade, mitigacións, parches e actualizacións.",
    "If you need to stay longer on your current version without disruptions, you don't have to run software without security updates." : "Se quere manterse algún tempo máis na súa actual versión sen interrupción, non ten que executar software sen actualizacións de seguridade. ",
    ...
    "You have access to the right documentation and expertise to quickly answer compliance questions or deliver on GDPR, HIPAA and other regulation requirements." : "Ten acceso á documentación e coñecementos axeitados para responder rapidamente ás preguntas de cumprimento ou para cumprir cos requisitos GDPR, HIPAA e outros requisitos regulamentarios.",
    "We can also provide Outlook integration, Online Office, scalable integrated audio-video and chat communication an other features only available in a limited form for free or develop further integrations and capabilities to your needs." : "Tamén podemos fornecerlle a integración co Outlook, Office en liña, comunicación integrada de son e video escalábel e outras funcións que só están dispoñíbeis de forma limitada de balde ou desenvolver máis integracións e capacidades ás súas necesidades.",
    "A subscription helps you get the most out of Nextcloud!" : "Unha subscrición axúdalle a obter o mellor do Nextcloud!",
    ...
    "This mail was sent to all administrators by the support app on your Nextcloud instance at %s because you have more users than your subscription covers." : "Este correo foi enviado a todos os administradores polo aplicativo de asistencia na súa instancia do Nextcloud en %s porque ten máis usuarios dos cubertos pola subscrición.",
