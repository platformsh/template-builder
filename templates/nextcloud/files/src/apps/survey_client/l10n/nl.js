OC.L10N.register(
    "survey_client",
    {
    "Last report sent on: {on}" : "Laatste rapportage verstuurd op: {on}",
    ...
    "Server instance details <em>(version, memcache used, status of locking/previews/avatars)</em>" : "Server details <em>(versie, memcache gebruikt, status van locking/previews/avatars)</em>",
