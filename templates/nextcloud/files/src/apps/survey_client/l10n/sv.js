OC.L10N.register(
    ...
    "We take your privacy seriously. Sending data is disabled by default, and should you choose to turn it on, it will be anonymized first, and you are given the option of what things to share. Upon receiving a report, the previous one is removed. Upload a clean report to delete all data currently stored on the server" : "Vi tar din integritet på allvar. Skicka data är inaktiverat som standard och om du ändå vill sätta på det blir det först anonymiserat och du får välja vad som ska delas. När en rapport tas emot kommer den förra tas bort. Ladda upp en ren rapport för att ta bort alla data som lagras på servern nu",
