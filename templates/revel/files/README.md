# Revel template for Platform.sh

This project provides a template application using the Revel web framework on Platform.sh. It is primarily an example, although could be used as the starting point for a real project.
...
* [Revel API documentation](https://godoc.org/github.com/revel/revel).
